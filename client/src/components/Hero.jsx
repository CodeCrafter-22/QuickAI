...
const Hero = () => {
  ...
  return (
    <div className='px-4 sm:px-20 xl:px-32 realative inline-flex flex-col w-full justify-center bg-[url(/gradientBackground.png)] bg-cover bg-no-repeat min-h-screen'>
        ...
        <div className='text-center mb-6'>
            ...
            <p className='mt-4 max-w-xs sm:max-w-lg 2xl:max-w-xl m-auto max-sm:text-xs text-gray-600'> Transform your content creation with our suit of premium AI tools. Write articles, generate images, and enhance your workflow.</p>
        </div>
